...
s.geometry('500x500')
s.resizable(0,0)
s.iconbitmap("icons\pydesktop.ico")
s.config(bg='blue')
...
def todo():
    ...
    root.iconbitmap("icons\work.ico")
...
def snake():
    ...
    root.iconbitmap("icons\Snake.ico")
...
def wea():
    ...
    root = Toplevel()
    root.iconbitmap("icons\weather 1.ico")
    root.title('weather')
...
def note():
    class Notepad:
        ...
        __root = Toplevel()
        __root.iconbitmap("icons\ Notepad.ico")
        ...
        def __showAbout(self):
            showinfo("Notepad", "you got fooled")
...
b9=Button(s,text='notepad',command=note).place(x=50,y=100)
def clock():
